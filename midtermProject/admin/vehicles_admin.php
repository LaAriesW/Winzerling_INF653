        ...
        <?php foreach ($vehicles as $vehicle): ?>
            <div class="list_row">
                <div class="list_item">
                    ...
                    <p class="bold">
                        <?= htmlspecialchars($vehicle['Class']) ?>
                    </p>
                    <p class="bold">
                ...
                <form action="." method="post">
                    <input type="hidden" name="action" value="delete_admin_vehicle">
                    ...
                    <input type="hidden" name="vehicle_type_id" value="<?= $vehicle['type_id'] ?>">
                    <input type="hidden" name="vehicle_class_id" value="<?= $vehicle['class_id'] ?>">
                    <input type="hidden" name="vehicle_make_id" value="<?= $vehicle['make_id'] ?>">
                    <button class="remove-button" onclick="return confirm('Really want to delete this vehicle?')">X</button>
                </form>
            </div>
        <?php endforeach; ?>
    </section>
...
<section>
    ...
    <form action="." method="post" id="add_form" class="add_vehicle_form">
        <input type="hidden" name="action" value="add_admin_vehicle">
